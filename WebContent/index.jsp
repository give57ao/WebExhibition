 ...
 <div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
       ...
       <div class="carousel-item active">
        <a href="#">
        <img class="d-block w-100" src="https://image.jtbcplus.kr/data/contents/jam_photo/202006/18/3654b80c-54d9-450c-b22c-a5c9f800db64.jpg" alt="Second slide"> 
        </a>
        <div class="carousel-caption d-none d-md-block">
        <h5>Composition in Blue</h5> <p>이광호</p>
        </div>
        </div> 
        
        <div class="carousel-item">
        <a href="#">
        <img class="d-block w-100" src="http://localhost:8080/test003/images/2021052317135836943_l.png" alt="Third slide"> 
        </a> 
        <div class="carousel-caption d-none d-md-block">
        <h5>대구신세계 </h5> <p>아트 앤 퍼니쳐</p>
        </div>
        </div> 
        
          <div class="carousel-item">
        <a href="#">
        <img class="d-block w-100" src="http://localhost:8080/test003/images/22MK8D6OEI_111.png" alt="Third slide"> 
        </a> 
        <div class="carousel-caption d-none d-md-block">
        <h5> </h5> <p>아트프로젝트씨오 전시회</p>
        </div>
        </div> 
        <!-- / 슬라이드 쇼 끝 --> 
        ...
        <div class="news">
           <div><h1>News</h1></div>
           <div class="view"><a href="news.jsp">view all</a></div>
        </div>
